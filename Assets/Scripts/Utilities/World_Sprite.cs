/*
    ===========================================================
    🧭 CHEATSHEET: World_Sprite
    Цель: Создаёт и управляет объектами-спрайтами в мире Unity, оборачивая их в удобный «класс-обёртку» с функционалом, похожим на World_Bar. Нужен для быстрого создания спрайтов и кнопок прямо в игровом мире, без необходимости вручную добавлять GameObject, SpriteRenderer и Collider.
    ===========================================================
*/
...
namespace VashValeriy.Utilities {
    ...
    public class World_Sprite {
        ...
        public static World_Sprite CreateDebugButton(Transform parent, Vector3 localPosition, string text, System.Action ClickFunc, int fontSize = 30, float paddingX = 5, float paddingY = 5) {
            ...
            Color colorOver = color * 1.1f; // кнопка на цвет светлее
