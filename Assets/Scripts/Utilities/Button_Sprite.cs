/*
    ===========================================================
    🧭 CHEATSHEET: Button_Sprite
    Цель: кастомный класс кнопки для Unity,который можно навешивать на SpriteRenderer-объект, чтобы он вёл себя как кнопка, но в 2D/3D-мире, а не в UI Canvas.
    ===========================================================
*/
