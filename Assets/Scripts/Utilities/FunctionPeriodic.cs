...
namespace VashValeriy {
    ...
    public class FunctionPeriodic {
        ...
        // Запускать [действие] каждый [таймер], выполнить [testDestroy] после запуска действия, уничтожить, если возвращает true
