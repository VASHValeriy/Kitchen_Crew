/*
    ===========================================================
    🧭 CHEATSHEET: FunctionTimer
    Purpose: вызова действий с определённым интервалом
    ===========================================================
*/
...
namespace VashValeriy {
    ...
    public class FunctionTimer {
        ...
        private static List<FunctionTimer> timerList; // Содержит ссылку на все активные таймеры.
        private static GameObject initGameObject; // Глобальный игровой объект, используемый для инициализации класса, уничтожается при смене сцены.
        ...
        // Создать объект, который необходимо обновить вручную с помощью Update();
