/*
    ===========================================================
    🧭 CHEATSHEET: Button_UI
    Цель: вторая версия предыдущего Button_Sprite, но для UI Canvas.
    ===========================================================
*/
...
namespace VashValeriy.Utilities {
    ...
    public class Button_UI : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IPointerClickHandler, IPointerDownHandler, IPointerUpHandler {
        ...
        /*
        * Класс для временного перехвата действия кнопки
        * Полезно для обучения отключению определенных кнопок
        * */
