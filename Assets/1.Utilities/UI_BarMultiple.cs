/*
    ===========================================================
    🧭 CHEATSHEET: UI_BarMultiple

    Цель: Контейнер пользовательского интерфейса с несколькими панелями, полезный для отображения одной панели с 
          несколькими внутренними панелями, например, вероятностью успеха и вероятностью неудачи.
    ===========================================================
*/
