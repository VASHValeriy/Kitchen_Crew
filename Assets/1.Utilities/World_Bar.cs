/*
    ===========================================================
    🧭 CHEATSHEET: World_Bar
    Цель: Утилита для создания и управления полосками (барами) прямо в игровом мире Unity, например:
          • полоска здоровья над врагом,
          • индикатор выносливости,
          • прогресс-бар квеста и т.д.
    ===========================================================
*/
